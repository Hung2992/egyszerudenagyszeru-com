    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Container style={container}>
          <Heading style={h1}>
            Profilod frissítve{name ? `, ${name}` : ''}!
          </Heading>
          <Text style={text}>
            A profilod adatai sikeresen módosultak. Ha nem te végezted ezt a módosítást, kérjük <strong>azonnal változtasd meg a jelszavadat</strong>.
          </Text>
          <Hr style={hr} />
